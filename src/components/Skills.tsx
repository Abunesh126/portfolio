...
const Skills = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const skillsVisibility = Math.max(0, Math.min(windowHeight, skillsRect.bottom) - Math.max(0, skillsRect.top)) / windowHeight;
      ...
      if (skillsVisibility < 0.2) {
        ...
        if (heroSection) {
          ...
          const heroVisibility = Math.max(0, Math.min(windowHeight, heroRect.bottom) - Math.max(0, heroRect.top)) / windowHeight;
        ...
        if (projectsSection) {
          ...
          const projectsVisibility = Math.max(0, Math.min(windowHeight, projectsRect.bottom) - Math.max(0, projectsRect.top)) / windowHeight;
